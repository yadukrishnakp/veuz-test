...
WSGI_APPLICATION = 'veuz_core.wsgi.application'
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'veuz_core.exceptions.handle_exception',
...
REVIEW_MAIL_URL = os.environ.get('REVIEW_MAIL_URL')
